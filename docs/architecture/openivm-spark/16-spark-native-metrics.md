...
| `openivm.create.catalog_publication_admission.queued` | gauge | creates | Named Delta-table registrations waiting for a catalog-publication lane. |
| `openivm.create.catalog_publication_admission.inflight` | gauge | creates | Named Hive/external-catalog registrations in flight; path CTAS work is not admitted here. |
| `openivm.create.catalog_publication_admission.width` | gauge | lanes | Configured application-scoped publication width (default 32, clamped to 2–32). |
| `openivm.create.catalog_publication_admission.wait` | timer | ns | Wait for a named catalog-publication lane. |
